            ...
            {this.state.knowFixedCosts === 'yes' && 
              <Grid.Column>
                <div className='fixedCost-suggestion'>
                  Unsure about your total fixed costs? <Button basic className='noBorder' type='button' color='darkBlue' onClick={() => this.setState({ knowFixedCosts: 'no'})}>Add all fixed costs individually</Button>
                </div>
              </Grid.Column>
            }
