export const fixedCostFields = [
  ...
  {name: 'Other Monthly Costs', description: 'Amount paid per month on other ie: website hosting, ecommerce, online payments'},
  {name: 'Other Fixed Costs', description: 'Amount paid per month on any additional fixed costs not accounted for above'},
]
